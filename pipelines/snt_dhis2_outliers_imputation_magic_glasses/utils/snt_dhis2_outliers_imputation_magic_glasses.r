# ================================================
# Title: Main helpers for the Magic Glasses outliers imputation pipeline
# Description: Loading, MAD and seasonal detection helpers, and the standard output formatters
#   (detected, imputed, removed) sourced by the pipeline notebook.
# Dependencies: data.table, dplyr, tidyr, glue, forecast, future.apply, stats
# ================================================
