...
def snt_dhis2_incidence(n1_method: str, 
    ...
    Parameters
    ----------
    careseeking_filename : str
        Name of the Care Seeking Data file (should be located in ~/data/).
    reporting_rate_choice : str
        Reporting Rate method to use for the analysis ("conf", "any", or "dummy-snis").
    run_report_only : bool
